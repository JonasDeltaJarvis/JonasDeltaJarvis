...
- Cambridge A-Level Student at Crucible Leadership Academy
- Passionate about AI, Robotics, and Mechatronics
- Currently learning: Python and C++ for AI & Control Systems
- Participated in STEM competitions and innovation challenges
...
```txt
🎓  Cambridge A-Level @ Crucible Leadership Academy, Zambia
🤖  Building intelligent systems that solve real-world problems
🔧  Interests: AI · Robotics · Mechatronics · Control Systems
📚  Learning: Python · C++ · MATLAB · Embedded Systems
🌍  Mission: Use AI & Robotics to transform industries in Africa
⚡  Fun fact: The next tech revolution will come from Africa
```
...
| 🎛️ **Adaptive PID Research** | Fixed vs adaptive autonomous steering control study | MATLAB · Simulink · Control Theory |
...
<div align="center">
  <img height="180em" src="https://github-readme-stats.vercel.app/api?username=JonasDeltaJarvis&show_icons=true&theme=radical&include_all_commits=true&count_private=true&hide_border=true"/>
